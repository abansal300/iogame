...
export class HUD {
  ...
  private boostCountEl: HTMLElement;
  ...
  constructor() {
    ...
    this.boostCountEl = document.getElementById('boost-count')!;
  ...
  public updateBoostCount(count: number): void {
    this.boostCountEl.textContent = `⚡ ${count}`;
  }
